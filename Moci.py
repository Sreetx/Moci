...
while True:
    try:
        ...
        print("  {5} Funnycat")
        print("  {6} Israel SQL Injection Dork        [#] Konten luar")
        print("  {7} Server Info                       {S} Sqlmap")
        print("  {8} Readme/Tentang                    {M} Metasploit(Khusus Linux)")
        print('  {9} Keluar')
        pilih = input("\n   [?] Pilih opsi: ")
    ...
    # Tool's kami
        if pilih.strip() == '1':
            ...
            if tanya.lower() == 'y':
                ...
                with open('alone.zip', 'wb') as code:
                  code.write(r.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'alone.zip'\n")
        elif pilih.strip() == '2':
            print('\n [*] Deskripsi:')
            ...
            if tanya6.lower() == 'y':
                ...
                with open('ddos.zip', 'wb') as code2:
                  code2.write(da.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'ddos.zip'\n")
        elif pilih.strip() == '3':
            print('\n [*] Deskripsi:')
            ...
            if tanya7.lower() == 'y':
                ...
                with open('dslite.zip', 'wb') as code3:
                  code3.write(dal.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'dslite.zip'\n")
        elif pilih.strip() == '4':
            print('\n [*] Deskripsi:')
            ...
            if tanya13.lower() == 'y':
                print('\n [*] Mengunduh script....')
                df = requests.get('https://github.com/Sreetx/deweb/archive/refs/heads/main.zip')
                with open('defacer.zip', 'wb') as code9:
                  code9.write(df.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'defacer.zip'\n")
        elif pilih.strip() == '5':
            print('\n [*] Deskripsi')
            ...
            if tanya8.lower() == 'y':
                ...
                with open('funnycat.zip', 'wb') as code4:
                  code4.write(fun.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'funnycat.zip'\n")
        elif pilih.strip() == '6':
            print('\n [*] Deskripsi:')
            ...
            if tanya10.lower() == 'y':
                ...
                with open('dork.zip', 'wb') as code6:
                  code6.write(drk.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'dork.zip'\n")
        elif pilih.strip() == '7':
            print('\n [*] Deskripsi:')
            ...
            if tanya14.lower() == 'y':
                print('\n [*] Mengunduh script....')
                svi = requests.get('https://github.com/Sreetx/server-info/archive/refs/heads/main.zip')
                with open('serfo.zip', 'wb') as code10:
                  code10.write(svi.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'serfo.zip'\n")
        elif pilih.strip() == '8':
    ...
    # Konten luar
            ...
            if tanya11.lower() == 'y':
                ...
                with open('sqlmap.zip', 'wb') as code7:
                   code7.write(sql.content)
                print(' [*] Selesai')
                print(" [*] File disimpan dengan nama 'sqlmap.zip'\n")
        elif pilih.strip() == 'm':
            print(" [*] Deskripsi")
    ...
    except Exception: print('\n [!] Perangkan anda tidak terhubung ke internet...')
